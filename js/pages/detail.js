...
function getOTTIcon(name) {
  const logos = {
    ...
    'Paramount+': '<svg class="ott-logo" viewBox="0 0 24 24" fill="#FFFFFF"><path d="M12 0L2 9v6l10-9 10 9V9zm0 7.5L2 16.5V21l10-9 10 9v-4.5z"/></svg>',
